...
//
//   const rESTContryResponse = Convert.toRESTContryResponse(json);
//
...
export class Convert {
    public static toRESTContryResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTContryResponse")));
    }

    public static rESTContryResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTContryResponse"))), null, 2);
    }
}
